...
async function viewPlayerData(playerId) {
  try {
...
// Get player ID from command line arguments or default to 4
const playerId = process.argv[2] ? parseInt(process.argv[2], 10) : 4;
